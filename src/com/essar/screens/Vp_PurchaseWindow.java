...
import com.essar.dao.VpPurchaseDAO;
 ...
 * @author rahumathulla
 */
public class Vp_PurchaseWindow extends javax.swing.JFrame implements ActionListener{
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        // TODO add your handling code here:
            ...
            HashMap map = new HashMap();
            map.put("bill_no",txtInvoiceNumber.getText().trim()); 
        try {
            jr = JasperCompileManager.compileReport(reportString);
        } catch (JRException ex) {
            Logger.getLogger(Vp_PurchaseWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
            JasperPrint jp = null;
        try {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        Vp_PurchaseFind purchaseFind =  new Vp_PurchaseFind();
    ...
    private void btnViewAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewAllActionPerformed
        ...
        Vp_ViewPurchase purchaseView =  new Vp_ViewPurchase();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vp_PurchaseWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vp_PurchaseWindow().setVisible(true);
            }
        });
    }
    ...
    public void initializeForm(){
        ...
        VpPurchaseDAO navigationDAO =  new VpPurchaseDAO();
    ...
    public void savePurchaseForm(){
        ...
        VpPurchaseDAO billGenDAO =  new VpPurchaseDAO();
