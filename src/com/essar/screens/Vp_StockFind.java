 ...
 * @author rahumathulla
 */
public class Vp_StockFind extends javax.swing.JFrame implements ActionListener{
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(null!= txtHSNCode.getText() && !("".equals(txtHSNCode.getText())) && 
            ...
            QueryStrings.stockQuery = "SELECT * from stock_vp where hsn_code ='"+txtHSNCode.getText()+"' AND item_name like '%"+txtItemName.getText()+"%'" ;
        }else if(null!= txtHSNCode.getText() && !("".equals(txtHSNCode.getText()))){
            QueryStrings.stockQuery = "SELECT * from stock_vp where hsn_code ='"+txtHSNCode.getText()+"'";
        }else if(null!= txtItemName.getText() && !("".equals(txtItemName.getText()))){
            QueryStrings.stockQuery = "SELECT * from stock_vp where item_name like '%"+txtItemName.getText()+"%'" ;
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vp_StockFind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vp_StockFind().setVisible(true);
            }
        });
    }
